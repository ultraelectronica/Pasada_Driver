  ...
  void _showManualAddPassengerBottomSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return ManualAddPassengerSheet(seatType: seatType);
      },
    );
  }
}
...
class ManualAddPassengerSheet extends StatefulWidget {
  ...
  const ManualAddPassengerSheet({super.key, required this.seatType});
...
class _ManualAddPassengerSheetState extends State<ManualAddPassengerSheet> {
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
                              Constants.GRADIENT_COLOR_2, // Lime green
  ...
  void _handleAddPassenger() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text('Passenger added: ${widget.seatType}'),
